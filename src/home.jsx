...
import google from './assets/logo.jpg';
        ...
        <div className="review-homepage">
            <div className="review-card">
                ...
                <div className="card-body">
                    ...
                    >
                        <svg width="96" height="96" viewBox="0 0 24 24" className="google-icon">
                ...
                <div className="card-footer">
                    <h2 className="footer-hotel-name">CINDERELLA MOTEL</h2>
                    <p className="footer-hotel-tagline">110 San Felipe Rd, Hollister, California 95023, USA</p>
                    <p className="footer-hotel-tagline"><span style={{color:"white"}}>📞</span>+1 (831) 585-8443</p>
                </div>
            </div>
        </div>
    );
